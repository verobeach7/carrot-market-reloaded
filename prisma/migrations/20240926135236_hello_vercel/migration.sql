...
CREATE TABLE "LiveSteam" (
    ...
    CONSTRAINT "LiveSteam_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "LiveSteam" ADD CONSTRAINT "LiveSteam_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
